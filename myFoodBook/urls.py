...
urlpatterns = [
    ...
    path('reset-password/complete/', auth_views.PasswordResetCompleteView.as_view(template_name='foodBookApp/reset-password-complete.html'), name='password_reset_complete'),
